...
<div class="demo">
 ...
 <?php echo form_open('Main/Attend');?>

   <div class="row">
    <div class="col-8">
      <div class="input-group mb-4">
            <span class="input-group-text" id="basic-addon1"><b>Employee Name</b></span>
      ...
      <div class="input-group mb-4">
            ...
            <input type="Date" name="date" class="form-control" placeholder="Address" aria-label="Username" aria-describedby="basic-addon1">
      </div>
      ...
      <div class="input-group mb-4">
            <span class="input-group-text" id="basic-addon1"> <b>In-Time</b></span>
            <input type="time" name="intime"  class="form-control" placeholder="Date" aria-label="Username" aria-describedby="basic-addon1">
      </div>

      <div class="input-group mb-4">
            <span class="input-group-text" id="basic-addon1"> <b>Out-time</b></span>
            <input type="time" name="outtime"  class="form-control" placeholder="Date" aria-label="Username" aria-describedby="basic-addon1">
      </div>

    
<div>
   <div class="container" align="center">
       <button type="submit" name="register" class="btn btn-primary btn-lg">Submit</button>&nbsp &nbsp &nbsp &nbsp
