            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <?php echo form_open('Main/slogin');?>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Don't have account? <a href="<?php echo base_url('Main/sregister');?>">Register</a></p>
                    </div>
                <?php echo form_close();?>
              ...
              <div class="credits">
                ...
                Designed by <a href="https://bootstrapmade.com/">Avinash</a>
              </div>
