  ...
  <thead>
   ...
   <tbody>
    ...
    ?>      <tr>
      ...
      <td><button class=" btn btn-primary"><a href=""class="text-light">Add</a></button>&nbsp;&nbsp;&nbsp;&nbsp;
  <button class=" btn btn-danger"><a href="<?php echo base_url('Main/sdelete/'.$row->id)?>"class="text-light">delete</a></button></td>
    </tr>
  <?php } ?>
  </tbody>  
</table>
