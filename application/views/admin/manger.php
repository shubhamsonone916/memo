...
<div class="sidenav">
  ...
  <div class="dropdown-container">
    <a href="<?php echo base_url('Main/inword');?>">inword</a>
    <a href="#">purcheses</a>
    <a href="#">Inventory</a>
    <a href="#">Inword</a>
    <a href="#">Outword</a>
...
<div class="demo">
<h2>Manger Credentials </h2>
<div class="float-left">
<button class=" btn btn-success " class=""><a href="<?php echo base_url('Main/addman');?>"class="text-light">Add</a></button></div>
<br>
<table class="table">
  ...
  <thead>
   ...
   <tbody>
    ...
    ?>      <tr>
      ...
      <td><button class=" btn btn-primary"><a href="<?php echo base_url('');?>"class="text-light">update</a></button>&nbsp;&nbsp;&nbsp;&nbsp;
  <button class=" btn btn-danger"><a href="<?php echo base_url('Main/delete/'.$row->id)?>"class="text-light">delete</a></button></td>
    </tr>
  <?php } ?>
  </tbody>  
</table>
