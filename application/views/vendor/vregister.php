...
<?php echo form_open('Main/registerv');?>
...
/
  <div class="form-row">
    <div class="col form-group">
      <label>Codeno</label>   
        <input type="number" name="vcode"class="form-control" placeholder="">
    </div> 
    <div class="col form-group">
      <label>Vendor Name</label>
        <input type="text" name="vname" class="form-control" placeholder=" ">
    </div> 
    ...
    <div class="col form-group">
      <label>GSTNo</label>   
        <input type="float" name="gstno" class="form-control" placeholder="">
    </div>
    <div class="col form-group">
      <label>contact</label>   
...
<div class="border-top card-body text-center">Have an account? <a href="<?= base_url('Main/vendor');?>">Log In</a></div>
</div> <!-- card.// -->
</div> <!-- col.//-->
