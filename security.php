       ...
       <div class="row">
        ...
        <div class="col-2">
           <div class="form-container1">
               ...
               <form action="securityindex.php" method="POST">
                    <input type="text" placeholder="Username" name="username" required>
                    <input type="text" placeholder="Security Code" name="securitycode" required>
                    <button type="submit" class="btn-losi" name="login" >Login</button> 
...
if(isset($_POST['login'])){
   ...
   // $res=mysqli_query("SELECT * FROM security WHERE username='$username' AND securitycode='$securitycode');
...
if($result)
{
    ...
    echo "Invalid Username or Securitycode";
}
